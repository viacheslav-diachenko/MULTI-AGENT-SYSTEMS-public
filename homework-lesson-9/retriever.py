"""Hybrid retrieval — FAISS + BM25 + RRF + Infinity reranker.

Verbatim from hw8 (see hw8 README 1.3.0 notes on pre-rerank filtering).
"""
...
class HybridRetriever(BaseRetriever):
    ...
    def search(
        ...
        *,
        ...
        merged = reciprocal_rank_fusion([semantic_docs, bm25_docs], k=self.rrf_k)
