"""Research Agent with RAG — interactive entry point.

Runs a REPL loop where the user types questions and the agent
autonomously searches the knowledge base and web, then generates reports.
"""
...
# Configure logging — suppress all library noise
logging.basicConfig(
    level=logging.ERROR,
...
def main() -> None:
    """Interactive REPL for the Research Agent with RAG."""
    print("=" * 50)
    print("  Research Agent with RAG")
